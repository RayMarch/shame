...
impl<X: Shape> ScalarOrSame for (X, X) {
    type Widest = X;
}

//impl<X: Shape> ScalarOrSame for (scal, X) {}
//impl ScalarOrSame for (scal, scal) {} //handled by (X, X)
impl ScalarOrSame for (scal, vec2) {
    type Widest = vec2;
}
impl ScalarOrSame for (scal, vec3) {
    type Widest = vec3;
}
impl ScalarOrSame for (scal, vec4) {
    type Widest = vec4;
}
impl ScalarOrSame for (scal, mat2) {
    type Widest = mat2;
}
impl ScalarOrSame for (scal, mat2x3) {
    type Widest = mat2x3;
}
impl ScalarOrSame for (scal, mat3x2) {
    type Widest = mat3x2;
}
impl ScalarOrSame for (scal, mat2x4) {
    type Widest = mat2x4;
}
impl ScalarOrSame for (scal, mat4x2) {
    type Widest = mat4x2;
}
impl ScalarOrSame for (scal, mat3) {
    type Widest = mat3;
}
impl ScalarOrSame for (scal, mat3x4) {
    type Widest = mat3x4;
}
impl ScalarOrSame for (scal, mat4x3) {
    type Widest = mat4x3;
}
impl ScalarOrSame for (scal, mat4) {
    type Widest = mat4;
}
...
impl ScalarOrSame for (mat2x3, scal) {
    type Widest = mat2x3;
}
impl ScalarOrSame for (mat3x2, scal) {
    type Widest = mat3x2;
}
impl ScalarOrSame for (mat2x4, scal) {
    type Widest = mat2x4;
}
impl ScalarOrSame for (mat4x2, scal) {
    type Widest = mat4x2;
}
impl ScalarOrSame for (mat3, scal) {
    type Widest = mat3;
}
impl ScalarOrSame for (mat3x4, scal) {
    type Widest = mat3x4;
}
impl ScalarOrSame for (mat4x3, scal) {
    type Widest = mat4x3;
}
impl ScalarOrSame for (mat4, scal) {
    type Widest = mat4;
}
