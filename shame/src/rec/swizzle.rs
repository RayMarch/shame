...
impl<S: IsVecOfAtLeast2, D: DType> Ten<S, D> {
    ...
    pub fn x_mut(&mut self) -> &mut Ten<scal, D> {
        self.swizzle.reset_and_get_mut(self.any.x(), self.stage)
    }
    /// mutable lvalue referencing the vector's y component
    ///
    /// `vector.y_mut().set(value)`
    pub fn y_mut(&mut self) -> &mut Ten<scal, D> {
        self.swizzle.reset_and_get_mut(self.any.y(), self.stage)
    }

    /// a vector's x component
    pub fn x(&self) -> Ten<scal, D> {
        Ten::from_downcast(self.any.x(), self.stage)
    }
    /// a vector's y component
    pub fn y(&self) -> Ten<scal, D> {
        Ten::from_downcast(self.any.y(), self.stage)
    }

    /// a 2 component vector made up of `self`'s x and y component
    pub fn xy(&self) -> Ten<vec2, D> {
        Ten::from_downcast(self.any.swizzle(&[X, Y]), self.stage)
    }
...
impl<S: IsVecOfAtLeast3, D: DType> Ten<S, D> {
    ...
    pub fn z_mut(&mut self) -> &mut Ten<scal, D> {
        self.swizzle.reset_and_get_mut(self.any.z(), self.stage)
    }

    /// a vector's z component
    pub fn z(&self) -> Ten<scal, D> {
        Ten::from_downcast(self.any.z(), self.stage)
    }

    /// a 2 component vector made up of `self`'s y and z components
    pub fn yz(&self) -> Ten<vec2, D> {
        Ten::from_downcast(self.any.swizzle(&[Y, Z]), self.stage)
    }
    /// a 2 component vector made up of `self`'s x and z components
    pub fn xz(&self) -> Ten<vec2, D> {
        Ten::from_downcast(self.any.swizzle(&[X, Z]), self.stage)
    }
    ...
    pub fn xy_mut(&mut self) -> &mut Ten<vec2, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[X, Y]), self.stage)
    }
    ...
    pub fn yz_mut(&mut self) -> &mut Ten<vec2, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[Y, Z]), self.stage)
    }
    ...
    pub fn xz_mut(&mut self) -> &mut Ten<vec2, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[X, Z]), self.stage)
    }

    /// a 3 component vector made up of `self`'s x, y, z components
    pub fn xyz(&self) -> Ten<vec3, D> {
        Ten::from_downcast(self.any.swizzle(&[X, Y, Z]), self.stage)
    }
...
impl<D: DType> Ten<vec4, D> {
    ...
    pub fn w_mut(&mut self) -> &mut Ten<scal, D> {
        self.swizzle.reset_and_get_mut(self.any.w(), self.stage)
    }

    /// a vector's w component
    pub fn w(&self) -> Ten<scal, D> {
        Ten::from_downcast(self.any.w(), self.stage)
    }
    ...
    pub fn zw_mut(&mut self) -> &mut Ten<vec2, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[Z, W]), self.stage)
    }

    /// a 2 component vector made up of `self`'s z and w components
    pub fn zw(&self) -> Ten<vec2, D> {
        Ten::from_downcast(self.any.swizzle(&[Z, W]), self.stage)
    }
    ...
    pub fn xyz_mut(&mut self) -> &mut Ten<vec3, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[X, Y, Z]), self.stage)
    }
    ...
    pub fn yzw_mut(&mut self) -> &mut Ten<vec3, D> {
        self.swizzle
            .reset_and_get_mut(self.any.swizzle(&[Y, Z, W]), self.stage)
    }

    /// a 3 component vector made up of `self`'s y, z, w components
    pub fn yzw(&self) -> Ten<vec3, D> {
...
pub trait IsSwizzleMembers: Copy {
    ...
    fn reset_and_get_mut<SubS: Shape, D: DType>(
        &mut self,
        any: Any,
        stage: Stage,
    ) -> &mut Ten<SubS, D>;
