...
impl Ten<scal, bool> {
    ...
    pub fn then(&self, recording_fn: impl FnOnce() + 'static) {
        //TODO: +'static is experimental to prevent variable "smuggling" out of scope
    ...
    /// not conditionally executed at all. It runs either way since
    /// self's value cannot be known when recording the shader
    pub fn then_else(&self, then_fn: impl FnOnce(), else_fn: impl FnOnce() + 'static) {
        //TODO: +'static is experimental to prevent variable "smuggling" out of scope
