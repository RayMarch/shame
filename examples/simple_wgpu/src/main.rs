...
async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    println!("this example is copy pasted together from wgpu examples. The timing code is far from great, because of my limited understanding of winit + wgpu. Please only pay attention to the wgpu/shame glue code. have fun!");
